      ...
      <div class="card-body">
        <form method="post" action="">
          <div class="form-group">
            <label for="email-subject" style="margin-top: 1rem; font-size:2.7vmin; margin-bottom:7px"> Email Subject</label>
          ...
          <br>
          <div class="form-group">
            <label for="email-content" style="font-size:2.7vmin; margin-bottom:7px">Email Content</label>
          ...
          <div class="form-group">
            ...
            <div style="text-align:center">
              ...
              <button class="button2" onclick="window.location.href='<?=base_url()?>/dashboard'" style=""><i class="bi bi-x-circle"></i> Cancel</button>
            </div>
          </form>
          </div>
        </div>
